      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mb-4">
            <Icon name="confirmation_number" size={28} className="text-white" />
          </div>
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border p-8">
          ...
          {error && (
            <div className="flex items-center gap-2 bg-error-bg text-error-fg text-sm px-4 py-3 rounded-lg mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-lg border border-input bg-white text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-colors"
              />
            </div>
